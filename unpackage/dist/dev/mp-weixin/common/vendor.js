...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"uniapp-base01","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 112:
/*!*****************************************************************************************************!*\
  !*** /Users/guojun/Desktop/uniapp/uniapp-music/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // import $store from '../../store/index.js';
var _default =
{
  //全局配置
  baseUrl: "http://localhost:3000",
  //请求返回Promise对象
  request: function request(url, options) {var showLoading = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;var contentType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
    //请求
    var requeUrl = this.baseUrl + url;
    return new Promise(function (resolve, reject) {
      // 发起请求
      uni.request({
        url: requeUrl,
...
/***/ 19:
/*!********************************************************************!*\
  !*** /Users/guojun/Desktop/uniapp/uniapp-music/common/js/index.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.apiGetRecommendSong = apiGetRecommendSong;exports.apiGetRelatedVideo = apiGetRelatedVideo;exports.apiGetTopAlbum = apiGetTopAlbum;exports.getBannerList = getBannerList;var _requestHelper = _interopRequireDefault(__webpack_require__(/*! ./requestHelper.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

// 轮播图列表
function getBannerList(data) {
  return _requestHelper.default.get('/banner', data);
}

//  推荐歌单
function apiGetRecommendSong(data) {
  return _requestHelper.default.get('/personalized', data);
}

//  新碟新歌
function apiGetTopAlbum(data) {
  return _requestHelper.default.get('/album/newest', data);
}

// 精选视频
function apiGetRelatedVideo(data) {
  return _requestHelper.default.get('/related/allvideo', data);
}
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.apiGetNavList = apiGetNavList;var _requestHelper = _interopRequireDefault(__webpack_require__(/*! ./requestHelper.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
